...
![](G:/Github/LFS/Iran-Labor-Force-Survey/docs/Figures/Employment Status.svg)
...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Total_Employment",y2="EMPR_T" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(20,24.5))
...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Female_Employment",y2="EMPR_F" ,Main = "Female Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(3,4.5))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Urban_Employment",y2="EMPR_U" ,Main = "Urban Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(13,18))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Rural_Employment",y2="EMPR_R" ,Main = "Rural Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(6,7.5))
...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Total_Unemployment",y2="UMPR_T" ,Main = "Total Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = range(LFS_Indicators_Y$Total_Unemployment))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Male_Unemployment",y2="UMPR_M" ,Main = "Male Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(1.5,2.3))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Female_Unemployment",y2="UMPR_F" ,Main = "Female Employment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(0.6,1.1))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Urban_Unemployment",y2="UMPR_U" ,Main = "Urban Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(1.75,2.75))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Rural_Unemployment",y2="UMPR_R" ,Main = "Rural Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(0.45,0.62))

range(LFS_Indicators_Y$Total_Unemployment)
...
P1 <- LFSINP1("Total_Participation",xlab = "Year",ylab = "Participated Population",Main = "Total Participation")
P2 <- LFSINP1("Male_Participation",xlab = "Year",ylab = "Participated Population",Main = "Male Participation")
P3 <- LFSINP1("Female_Participation",xlab = "Year",ylab = "Participated Population",Main = "Female Participation")
P4 <- LFSINP1("Urban_Participation",xlab = "Year",ylab = "Participated Population",Main = "Urban Participation")
P5 <- LFSINP1("Rural_Participation",xlab = "Year",ylab = "Participated Population",Main = "Rural Participation")
