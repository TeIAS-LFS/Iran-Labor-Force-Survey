...
LFSINP2 <- function(df,x = "",y1 = "", y2 = "", Main = "",y1l = "" ,y2l = "",y1lim =NULL ){
  P <- twoord.plot(lx = x, ly =y1 , rx = x , ry =y2, data = df,lylim = y1lim,mar = c(6,5,5,5),
...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Total_Employment",y2="EMPR_T" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(20,25))
...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Female_Employment",y2="EMPR_F" ,Main = "Female Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(3,4.4))
...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Rural_Employment",y2="EMPR_R" ,Main = "Rural Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(6,7.4))
...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Total_Unemployment",y2="UMPR_T" ,Main = "Total Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(2.2,3.41))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Male_Unemployment",y2="UMPR_M" ,Main = "Male Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(1.6,2.31))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Female_Unemployment",y2="UMPR_F" ,Main = "Female Employment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(0.6,1.11))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Urban_Unemployment",y2="UMPR_U" ,Main = "Urban Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(1.8,2.81))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Rural_Unemployment",y2="UMPR_R" ,Main = "Rural Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(0.45,0.66))
