...
P1<- LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Total_Employment",y2="EMPR_T" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(20.5,24.5))

P2 <- LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Male_Employment",y2="EMPR_M" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(16.5,20))

P3 <- LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Female_Employment",y2="EMPR_F" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(3,4.5))

P4 <- LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Urban_Employment",y2="EMPR_U" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(13.2,17.9))

P5 <- LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Rural_Employment",y2="EMPR_R" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(6.1,7.4))
