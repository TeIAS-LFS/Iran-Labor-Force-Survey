...
LFSINP <- function(df,x = "",y1 = "", y2 = "", Main = "",y1l = "" ,y2l = "",y1lim =NULL ){
  P <- twoord.plot(lx = x, ly =y1 , rx = x , ry =y2, data = df,lylim = y1lim,
...
layout(matrix(c(1,2,3,4,5),nrow = 3 ,ncol = 2 ,byrow = T))
LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Total_Employment",y2="EMPR_T" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(20.5,24.5))

LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Male_Employment",y2="EMPR_M" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(16.5,20))

LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Female_Employment",y2="EMPR_F" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(3,4.5))

LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Urban_Employment",y2="EMPR_U" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(13.2,17.9))

LFSINP(LFS_Indicators_Y,x = "Year",y1 = "Rural_Employment",y2="EMPR_R" ,Main = "Total Employment",y1l = "Employed Pop (Million)",y2l = "Employment rate (%)",y1lim = c(6.1,7.4))
