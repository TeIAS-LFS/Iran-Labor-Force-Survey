...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Total_Unemployment",y2="UMPR_T" ,Main = "Total Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(2.2,3.4))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Male_Unemployment",y2="UMPR_M" ,Main = "Male Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(1.6,2.3))
...
LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Urban_Unemployment",y2="UMPR_U" ,Main = "Urban Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(1.8,2.8))

LFSINP2(LFS_Indicators_Y,x = "Year",y1 = "Rural_Unemployment",y2="UMPR_R" ,Main = "Rural Unemployment",y1l = "Unemployed Pop (Million)",y2l = "Unemployment rate (%)",y1lim = c(0.45,0.65))
