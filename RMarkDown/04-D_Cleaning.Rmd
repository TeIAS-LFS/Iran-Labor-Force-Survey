...
![NR Diagram For Year After 1387](C:/Users/ali/Dropbox/LFS Cleaning/GitHub/NR Diagram_Befor_87.png)
![NR Diagram For Year Before 1387](C:/Users/ali/Dropbox/LFS Cleaning/GitHub/NR Diagram_After_87.png)
...
![](C:/Users/ali/Dropbox/LFS Cleaning/GitHub/NR_F2_Diagram.png)
...
ggarrange(Demog("Total_population"),                                          ggarrange(Demog("Male_T"), Demog("Female_T"), ncol = 2),nrow = 2)
```

```{r,echo=FALSE,fig.height=10,fig.width=10}
ggarrange(Demog("Urban_T"),                                          ggarrange(Demog("Urban_M"), Demog("Urban_F"), ncol = 2),nrow = 2)
```

```{r,echo=FALSE,fig.height=10,fig.width=10}
ggarrange(Demog("Rural_T"),                                          ggarrange(Demog("Rural_M"), Demog("Rural_F"), ncol = 2),nrow = 2)
```
