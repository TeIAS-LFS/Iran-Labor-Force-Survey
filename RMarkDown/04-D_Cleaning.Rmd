...
![NR Diagram For Year After 1387](C:/Users/ali/Dropbox/LFS Cleaning/GitHub/RMarkDown/Figures/NR Diagram_Befor_87.png)
![NR Diagram For Year Before 1387](C:/Users/ali/Dropbox/LFS Cleaning/GitHub/RMarkDown/Figures/NR Diagram_After_87.png)
...
```{r,eval=FALSE}
  FORM2JOZ <- FORM2JOZ%>%
    ...
    mutate_at(vars(Birth_Year,Birth_Month,Age),as.integer)%>%
    mutate_at(vars(Relation,Gender,Nationality,Residence_Status,
...
![](C:/Users/ali/Dropbox/LFS Cleaning/GitHub/RMarkDown/Figures/NR_F2_Diagram.png)
...
<img src="https://render.githubusercontent.com/render/math?math=\text{Adjustment coefficient}_{s} = \frac{\text{Number of people in the group s according to intercensal estimation}}{\text{Number of people in group s according to data}}">
...
Demog("Total_population",xlab = "Year",ylab = "Population(Million)",title = "Total Population",Total_Pop_C,Total_Pop_R)
```

```{r,echo=FALSE,fig.height=5,fig.width=10}
ggpubr::ggarrange(Demog("Male_T",xlab = "Year",ylab = "Population(Million)",title = "Male Population",Total_Pop_C,Total_Pop_R),
                  Demog("Female_T",xlab = "Year",ylab = "Population(Million)",title = "Female Population",Total_Pop_C,Total_Pop_R),
                  ncol = 2,nrow = 1)
```

```{r,fig.width= 10 ,fig.height=10,echo=FALSE}
Demog("Urban_T",xlab = "Year",ylab = "Population(Million)",title = "Urban  Population",Total_Pop_C,Total_Pop_R)
```

```{r,fig.width=10,fig.height=5,echo=FALSE}
ggpubr::ggarrange(Demog("Urban_M",xlab = "Year",ylab = "Population(Million)",title = "Urban Male  Population",Total_Pop_C,Total_Pop_R),
                  Demog("Urban_F",xlab = "Year",ylab = "Population(Million)",title = "Urban Female Population", Total_Pop_C,Total_Pop_R),
                  ncol = 2,nrow = 1)
```

```{r,fig.width=10,fig.height=10,echo=FALSE}
Demog("Rural_T",xlab = "Year",ylab = "Population(Million)",title = "Rural Population",Total_Pop_C,Total_Pop_R)

```

```{r,fig.height=5,fig.width=10,echo=FALSE}
ggpubr::ggarrange(Demog("Rural_M",xlab = "Year",ylab = "Population(Million)",title = "Rural Male Population",Total_Pop_C,Total_Pop_R),
                  Demog("Rural_F",xlab = "Year",ylab = "Population(Million)",title = "Rural Female Population",Total_Pop_C,Total_Pop_R),
                  ncol = 2,nrow = 1)
```
